"""
Django settings for TrustRealEstate project.
...
SECRET_KEY = 'django-insecure-b-a6)x=*5mu8z*qyj!@_7sdcm548mu=0d5ad+-#h-a+m)eh%z#'
...
ROOT_URLCONF = 'TrustRealEstate.urls'
...
WSGI_APPLICATION = 'TrustRealEstate.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
   BASE_DIR / 'TrustRealEstate/static',
]
